...
import muteIcon from '../../../resources/images/news/mute-unified.svg';
import speakerIcon from '../../../resources/images/news/unmute_unified.svg';
import playIcon from '../../../resources/svg/videoPlayerIcons/playIcon.svg';
import styles from './videoPlayer.module.scss';
import swipeGestureGif from '../../../resources/images/swipeGesture.gif';
import { useRouter } from 'next/router';
// import SpinnerLoader from '../../../components/common/SpinnerLoader/SpinnerLoader';
import { useSelector } from 'react-redux';

const VideoPlayer = props => {
    const { metadata = {} } = props.videoContent;
    const content = props.videoContent.contents?.[0];        
